package de.thu.realestate.adapters;
...
import de.thu.realestate.R;
import de.thu.realestate.activities.PropertyDetailActivity;
import de.thu.realestate.applicationData.property.Property;
...
public class PropertyAdapter extends RecyclerView.Adapter<PropertyAdapter.PropertyHolder> {
    ...
    public PropertyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
       View view = LayoutInflater.from(context).inflate(R.layout.property_listing_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull PropertyHolder holder, int position) {
        ...
        holder.propertyListingConstraintLayout.setOnClickListener(new View.OnClickListener(){
            @Override
    ...
    public class PropertyHolder extends RecyclerView.ViewHolder{
        ConstraintLayout propertyListingConstraintLayout;
        ImageView propertyCoverImageView;
        TextView priceView,bedCountView,bathCountView,areaView;
        public PropertyHolder(View itemView){
            super(itemView);
            propertyListingConstraintLayout = itemView.findViewById(R.id.propertyListingItem);
